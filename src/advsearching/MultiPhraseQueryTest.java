...
import analysis.synonym.SynonymAnalyzer;
import analysis.synonym.SynonymEngine;
...
public class MultiPhraseQueryTest extends TestCase {
    ...
    public void testBasic() throws Exception {
        ...
        query.add(new Term("field", "fox")); // or 逻辑关系
        System.out.println(query);

        TopDocs hits = searcher.search(query, 10);
        assertEquals("fast fox match", 1, hits.totalHits);

        query.setSlop(1); // 设置slop，可以匹配 the quick brown fox jumped over the lazy dog
    ...
    public void testQueryParser() throws Exception {
        ...
        assertTrue("parsed as MulitPhraseQuery", q instanceof MultiPhraseQuery);
